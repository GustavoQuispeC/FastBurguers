...
const Navbar = () => {
  ...
  return (
    <div className="shadow-md font-[sans-serif] tracking-wide relative z-50">
      <section className='py-2 bg-black text-white text-right px-10'>
      <p className='text-sm'><strong className="mx-3">Atención</strong>Delivery: hasta las 11pm.<strong className="mx-3">Recojo en tienda:</strong> hasta las 10pm.</p>
    </section>
      <div className="md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-200 border-b bg-blue-800 lg:min-h-[80px] max-lg:min-h-[60px]">
        ...
        <div className="flex flex-wrap w-full items-center">
          <input
            type="text"
            placeholder="Buscar..."
            className="xl:w-96 max-lg:w-full lg:ml-10 max-md:mt-4 max-lg:ml-4 bg-gray-100 px-6 rounded h-11 outline-[#333] text-sm transition-all"
          />
          <div className="ml-auto max-lg:mt-4">
            <ul className="flex items-center">
              <li className="max-sm:hidden flex text-[15px] max-lg:py-2 px-3 font-medium cursor-pointer text-white">
                <svg
      ...
      >
        ...
        <ul className="lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-white min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
          ...
          <li className="max-lg:border-b max-lg:py-3 px-3">
            <a
              href="#"
              className="hover:text-yellow-300 text-yellow-300 text-[15px] font-bold block"
            >
              Menú
            </a>
          </li>
          ...
          <li className="max-lg:border-b max-lg:py-3 px-3">
            <a
              href="#"
              className="hover:text-yellow-300 text-blue-800 text-[15px] font-bold block"
            >
              Promociones
            </a>
          </li>
