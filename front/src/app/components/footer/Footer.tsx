    ...
    return (
      ...
      >
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between gap-8 pt-16 pb-8">
            <FooterList>
            ...
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              ...
              <p className="mb-2">
                Welcome to Fast Burgers—your spot for quick, delicious burgers and more! We focus on fresh ingredients and speedy service to deliver a top-notch dining experience. Enjoy our range of burgers, sides, and drinks today.
              </p>
              <p>©{new Date().getFullYear()} Fast Burgers. All Rights Reserved.</p>
            </div>
