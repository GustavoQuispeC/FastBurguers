      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center">
        {products
          ...
          .map((product) => (
            <div
              key={product.id}
              className="flex flex-col items-center max-w-fit border border-gray-300 overflow-hidden rounded-lg relative"
            >
              <div className="bg-red-600 rounded-xl p-1 px-2 absolute left-4 top-5 z-10">
